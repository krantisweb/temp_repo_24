      ...
      >
        <div className="flex flex-col ">
          ...
          <div className="modal-details flex flex-row m-2 ">
            <p className="font-semibold w-2/4">ID: </p>
            <p className="text-gray-800 w-3/4 ">{rowData.ID}</p>
          </div>

          <div className="modal-details flex flex-row m-2 ">
            <p className="font-semibold w-2/4"> Vehicle</p>
            <p className="text-gray-800 w-3/4 ">{rowData.Vehicle}</p>
          </div>

          <div className="modal-details flex flex-row m-2 ">
            <p className="font-semibold w-2/4">OCR: </p>
            <p className="text-gray-800 w-3/4 ">{rowData.OCR}</p>
          </div>

          <div className="modal-details flex flex-row m-2 ">
            <p className="font-semibold w-2/4">Distance:</p>
            <p className="text-gray-800 w-3/4 ">{rowData.Distance}</p>
          </div>

          <div className="modal-details flex flex-row m-2">
            <p className="font-semibold w-2/4">Timestamp: </p>
            <p className="text-gray-800 w-3/4 ">{rowData.Timestamp}</p>
          </div>

          <div className="modal-details flex flex-row m-2 ">
            <p className="font-semibold w-2/4">NoPlate: </p>
            <img
              src={rowData.NoPlate}
              alt="NoPlate"
          ...
          <div className="modal-details flex flex-row m-2 ">
            <p className="font-semibold w-2/4">Image: </p>
            <img
              src={rowData.image_urls}
              alt="GIF"
              className=" rounded-lg  "
              style={{ maxWidth: "200px", height: "auto" }}
            />
